...
This is a personal portfolio project built to develop and demonstrate end-to-end data science skills: data engineering from messy nested data, rigorous machine learning methodology, and interpretable modeling.
...
## Progress
- [x] Milestone 0: Project setup, data acquisition, initial data inspection (`notebooks/00_data_inspection.ipynb`)
